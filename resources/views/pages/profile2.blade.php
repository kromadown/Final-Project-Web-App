<!doctype html>
	...
	<head>
        ...
        <link href="css/profile-style2.css" rel="stylesheet">
                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <span>{{ Auth::user()->name }} <span class="caret"></span>                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group row">
                                        <label for="fullName" class="col-4 col-form-label">Full Name</label> 
                                        <div class="col-8">
                                            <input id="fullName" name="fullName" placeholder="Full name" class="form-control here" type="text" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email" class="col-4 col-form-label">Email</label> 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input id="address" name="address" placeholder="Address" class="form-control here" type="text" required>
                                        </div>
                                    </div>
                                    <!-- </form> -->
                                    </div>
